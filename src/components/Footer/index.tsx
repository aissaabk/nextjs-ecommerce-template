          ...
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                CITE 160/500 LOGTS LPL Bloc:7 N⌀:9 - BOUGHEZOUL
              </li>

              <li>
                <a href="#" target="_blank" className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              <li>
                <a href="mailto:belmelahmed@gmail.com" target="_blank" className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
            ...
            <div className="flex items-center gap-4 mt-7.5">
              <a
                href="https://www.facebook.com/devbelmel"
                target="_blank"
              ...
              <a
                href="https://github.com/aissaabk"
                target="_blank"
...
>
  <path
    fillRule="evenodd"
    clipRule="evenodd"
    d="M10 .25C4.615.25.25 4.615.25 10c0 4.312 2.797 7.972 6.675 9.263.488.09.663-.213.663-.474 0-.234-.008-.856-.013-1.68-2.715.59-3.29-1.31-3.29-1.31-.444-1.13-1.085-1.43-1.085-1.43-.887-.605.067-.593.067-.593.98.07 1.495 1.007 1.495 1.007.87 1.49 2.283 1.06 2.84.81.088-.63.34-1.06.618-1.3-2.166-.245-4.446-1.084-4.446-4.823 0-1.065.38-1.935 1.007-2.615-.1-.245-.44-1.23.1-2.56 0 0 .827-.265 2.71 1.002A9.406 9.406 0 0 1 10 4.612c.84.003 1.684.113 2.473.332 1.882-1.267 2.708-1.002 2.708-1.002.54 1.33.2 2.315.1 2.56.63.68 1.005 1.55 1.005 2.615 0 3.75-2.285 4.575-4.455 4.813.35.3.662.89.662 1.792 0 1.296-.013 2.34-.013 2.658 0 .265.173.57.668.472A9.763 9.763 0 0 0 19.75 10c0-5.385-4.365-9.75-9.75-9.75Z"
    fill="currentColor"
  />
</svg>
              </a>
              ...
              <a
                href="linkedin.com/in/belmel-ahmed-004b291a7"
                target="_blank"
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy; {year}. All rights reserved by Team devbelmel.
            </p>
